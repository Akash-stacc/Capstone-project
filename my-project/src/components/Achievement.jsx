    ...
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 md:max-w-[600px] '>
            ...
            <div className='flex flex-col justify-center'>
              ...
              <p className='text-lg text-gray-600'>Actions speak louder than words! Give today</p>
            
              <div className='grid grid-cols-2 py-16 '>
                  <div className='py-6 flex'>
                      <div className='py-4 bg-[#E9F8F3] rounded-xl'>
                        <SlGraduation
                            size={30}
                            style={{color:'#1A906B'}}
                      ...
                      <div className='px-3'>
                        ...
                        <p className='text-[#6D737A]'>Graduates volunteer</p>
                      </div>

                  </div>
                  <div className='py-6 flex'>
                      <div className='py-4 bg-[#FFFAF5] rounded-xl'>
                        <FiVideo
                            size={30}
                            style={{color:'#FFC27A'}}
                  ...
                  <div className='py-6 flex'>
                      <div className='py-4 bg-[#FFEEF0] rounded-xl'>
                        <SlGraduation
                            size={30}
                            style={{color:'#ED4459'}}
                      ...
                      <div className='px-3'>
                        ...
                        <p className='text-[#6D737A]'>Student's volunteer</p>
                      </div>

                  </div>
                  <div className='py-6 flex'>
                      <div className='py-4 bg-[#F0F7FF] rounded-xl'>
                        <SlPeople
                            size={30}
                            style={{color:'#0075FD'}}
                      ...
                      <div className='px-3'>
                        ...
                        <p className='text-[#6D737A]'>Active Donor</p>
                      </div>
